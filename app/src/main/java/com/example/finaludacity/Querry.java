...
public class Querry {
    ...
    public static ArrayList<Data> fetchNewsDataFromJson(String newsJson) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                Data newsData = new Data(title, webUrl, sectionName, date, time, author);
    ...
    public static List<Data> fetchNewsData(String requestUrl) {
        ...
        List<Data> newsData = fetchNewsDataFromJson(jsonResponse);
        return newsData;
    }
